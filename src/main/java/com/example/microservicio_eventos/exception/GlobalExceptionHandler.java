...
public class GlobalExceptionHandler {
    ...
    /**
     * Captura errores cuando no se encuentra un evento por ID.
     */
    @ExceptionHandler(EventoNotFoundException.class) // <-- CAMBIADO
    public ResponseEntity<Object> handleEventoNotFound(EventoNotFoundException ex) { // <-- CAMBIADO
